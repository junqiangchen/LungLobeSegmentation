...
def categorical_dicePcrossentroy(Y_pred, Y_gt, weightdice, weightfocal, lamda1=100, lamda2=1):
    """
...
def categorical_dicePfocalloss(Y_pred, Y_gt, weightdice, weightfocal, lamda1=100, lamda2=1, gamma=4.):
    """
